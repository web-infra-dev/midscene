...
<video src="https://lf3-static.bytednsdoc.com/obj/eden-cn/vhaeh7vhabf/showcase-1-ui-tars.mp4" height="400" />

2. 控制 Android 上的地图应用（使用 Qwen-2.5-VL 模型）

<video src="https://lf3-static.bytednsdoc.com/obj/eden-cn/vhaeh7vhabf/showcase-2-android.mp4" height="400" />

3. 使用 midscene mcp 浏览页面 (https://www.saucedemo.com/)，执行登录、添加产品、下订单，最后基于 mcp 执行步骤和 playwright 示例生成测试用例

<video src="https://lf3-static.bytednsdoc.com/obj/eden-cn/vhaeh7vhabf/showcase-3-mcp.mp4" height="400" />
