...
* 千问系列: [Qwen3.6](./model-common-config#qwen36), [Qwen3.5](./model-common-config#qwen35), [Qwen3-VL](./model-common-config#qwen3-vl), [Qwen2.5-VL](./model-common-config#qwen25-vl)
