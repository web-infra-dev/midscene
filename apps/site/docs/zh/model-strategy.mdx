...
|GPT-5.4<br />[快速配置](./model-common-config#gpt-5-4)|[OpenAI](https://platform.openai.com/)|⭐⭐⭐<br />元素定位（Visual Grounding）不稳定，建议作为 Planning 模型<br />支持 [Codex App Server](./model-common-config#codex-app-server) |
