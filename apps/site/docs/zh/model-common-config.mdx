...
<ModelConfigCard
  ...
  modelFamily={{
    value: "qwen3",
    comment: "如果你使用了其他版本的 Qwen，需要替换为对应的 model family",
  }}
/>
...
<ModelConfigCard
  baseUrl={{
    ...
    comment: "OpenAI API 地址；或你的兼容服务地址",
  }}
  modelName="gpt-6-sol"
  modelFamily="gpt-6"
  responses
...
<ModelConfigCard
  baseUrl={{
    ...
    comment: "Moonshot AI API 地址",
  }}
  modelName="kimi-k3"
  modelFamily={{
    value: "kimi3",
    comment: "如果使用 kimi-k2.6，请改为 \"kimi\"",
  }}
/>
...
<ModelConfigCard
  baseUrl={{
    ...
    comment: "BigModel API 地址；Z.AI 使用 https://api.z.ai/api/paas/v4",
  }}
