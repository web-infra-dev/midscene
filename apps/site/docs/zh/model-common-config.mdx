...
### Gemini 系列 {#gemini-3-pro}

Gemini 系列中的 `gemini-3.5-flash` 是目前我们私有测评集中定位表现最好的模型。在 [Google Gemini](https://gemini.google.com/) 上申请 API Key 后，可以使用以下配置。

`MIDSCENE_MODEL_NAME` 请填写你使用的 Gemini 系列具体模型名：

```bash
MIDSCENE_MODEL_BASE_URL="https://generativelanguage.googleapis.com/v1beta/openai/"
MIDSCENE_MODEL_API_KEY="......"
MIDSCENE_MODEL_NAME="gemini-3.5-flash" # 或具体的 Gemini 模型名
