...
MIDSCENE_MODEL_FAMILY="gpt-5.4"
```

`MIDSCENE_MODEL_FAMILY="gpt-5"` 也仍然兼容，但无法使用 original resolution。参考：[model sizing behavior](https://developers.openai.com/api/docs/guides/images-vision#model-sizing-behavior)
