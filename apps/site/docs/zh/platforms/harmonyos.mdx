...
Midscene 通过 HarmonyOS Device Connector（HDC）自动化 HarmonyOS NEXT 设备。

## 案例展示

<ShowcaseHarmony />

查看更多 [Midscene 案例](../showcases.mdx)。
...
本节介绍如何自定义设备行为、把 Midscene 接入独立框架，以及排查 HDC 问题。更多构造函数参数位于 [API 参考的 HarmonyOS 章节](../reference/#harmonyos)。
...
- HarmonyOS 专属参数与接口：[API 参考（HarmonyOS）](../reference/#harmonyos)
