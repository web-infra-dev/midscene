...
### 🚀 新增 iOS 平台支持
v0.29 版本最大的亮点是正式引入了对 iOS 平台的支持！现在，你可以通过 WebDriver 连接并自动化 iOS 设备，将 Midscene 的强大 AI 自动化能力扩展到苹果生态系统，了解详情: [支持 iOS 自动化](./blog-support-ios-automation.mdx)

### 🤖 AI 核心能力增强
- **适配 Qwen3-VL 模型**：我们适配了最新的通义千问 `Qwen3-VL` 模型，进一步提升了视觉理解的准确性和效率
...
### 🐞 问题修复
- 修复了在使用 Puppeteer 时可能出现的点击操作签名问题，提升了 Web 自动化的兼容性
