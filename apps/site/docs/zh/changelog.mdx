...
## v1.9 - Markdown 回放与自动化修复

v1.9 版本带来 Markdown 回放输出、HarmonyOS YAML 自动化，并补充了 CLI、报告、模型和桌面自动化相关修复。当前最新版本可从 [GitHub Releases](https://github.com/web-infra-dev/midscene/releases/latest) 获取，该链接会自动跳转到最新 tag。
