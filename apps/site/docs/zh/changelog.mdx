...
## v1.9 - Studio 录制、Markdown 回放与 HarmonyOS YAML 目标

v1.9 版本带来 Studio 录制能力、Markdown 回放输出、HarmonyOS YAML 自动化，并补充了 CLI、报告、模型和桌面自动化相关修复。当前最新版本可从 [GitHub Releases](https://github.com/web-infra-dev/midscene/releases/latest) 获取，该链接会自动跳转到最新 tag。

### Midscene Studio Beta 录制功能

Midscene Studio 仍处于 **Beta** 阶段。可从 [latest release 页面](https://github.com/web-infra-dev/midscene/releases/latest) 下载，选择 `midscene-studio-beta-*` 资源即可。Beta 安装包直链：[macOS Apple Silicon DMG](https://github.com/web-infra-dev/midscene/releases/download/v1.9.2/midscene-studio-beta-v1.9.2-darwin-arm64.dmg)、[Windows x64 ZIP](https://github.com/web-infra-dev/midscene/releases/download/v1.9.2/midscene-studio-beta-v1.9.2-win32-x64.zip)、[Linux x64 ZIP](https://github.com/web-infra-dev/midscene/releases/download/v1.9.2/midscene-studio-beta-v1.9.2-linux-x64.zip)。
