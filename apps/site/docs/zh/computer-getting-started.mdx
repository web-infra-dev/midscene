...
Xvfb 会创建一个虚拟显示器，使鼠标、键盘和截图操作在没有物理显示器的情况下正常工作。配置方式详见 [API 参考](./computer-api-reference)，GitHub workflow 与示例报告详见 [集成到 GitHub Actions](./github-actions-integration)。
