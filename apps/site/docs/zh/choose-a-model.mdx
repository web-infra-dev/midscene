...
我们推荐在 UI 自动化中使用 VL 模型，因为它们可以原生地"看到"截图，在复杂场景中更加可靠和高效。
...
我们推荐使用 Qwen3-VL 系列的模型，它的性能大幅领先于其他所有模型，能带来更好的研发体验。使用 Qwen3-VL 系列的模型要求搭配 Midscene v0.29.3 及以上的版本。
