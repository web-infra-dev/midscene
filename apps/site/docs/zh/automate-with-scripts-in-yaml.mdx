...
android:
  ...
  # 输入完成后如何关闭键盘，可选
  # Android 支持 boolean，以及 'back' | 'esc' | 'midscene-ime' | 'midscene-ime-auto-install'
  ...
  # imeStrategy, displayId, autoDismissKeyboard, keyboardDismissStrategy（已废弃）,
  # alwaysRefreshScreenInfo 等
