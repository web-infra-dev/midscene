...
Planning uses sub-goals as needed. Configure separate Locate calls with `MIDSCENE_PLANNING_SEPARATE_LOCATE`; the legacy `deepThink` option is deprecated and ignored.
