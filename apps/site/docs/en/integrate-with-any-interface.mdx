...
* `planningFeedbackMaxLength`: optional character limit for `context.task.planningFeedback`. Omit it to use the core default of 500 characters, set a number to use an action-specific limit, or set `false` to disable truncation for this action.
