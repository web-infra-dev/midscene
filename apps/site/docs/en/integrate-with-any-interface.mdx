...
Please note that only models with visual grounding capabilities can be used to control the interface. Read [Model strategy](./model-strategy) to pick a suitable model.
...
Read [Model strategy](./model-strategy) to learn more.
