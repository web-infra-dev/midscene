...
- `screenshotResizeScale?: number` &mdash; **Deprecated.** Use `screenshotShrinkFactor` in `AgentOpt` instead. This option no longer affects screenshot size sent to the AI model.
