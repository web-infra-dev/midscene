...
When you need to customize device behavior, integrate Midscene into a standalone framework, or troubleshoot HDC issues, refer to this section. See [API Reference (HarmonyOS)](#api-reference) for more constructor parameters.
...
- HarmonyOS-specific parameters and interfaces: [HarmonyOS Agent API](#api-reference)
- Demo projects
