...
- [Bridge Mode by Chrome Extension](./bridge-mode)
...
### Can I install Midscene manually if the Chrome Web Store is unavailable?

Yes. Download the installation package from [Releases](https://github.com/web-infra-dev/midscene/releases) and load it manually, but note that this is not recommended because you won't receive automatic updates.
