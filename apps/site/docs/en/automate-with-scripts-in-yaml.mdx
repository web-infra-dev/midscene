...
android:
  ...
  # How to dismiss the keyboard after input, optional.
  # Android accepts boolean plus 'back' | 'esc' | 'midscene-ime' | 'midscene-ime-auto-install'.
  autoDismissKeyboard: <boolean | 'back' | 'esc' | 'midscene-ime' | 'midscene-ime-auto-install'>
  ...
  # imeStrategy, displayId, autoDismissKeyboard, keyboardDismissStrategy (deprecated),
  # alwaysRefreshScreenInfo, etc.
