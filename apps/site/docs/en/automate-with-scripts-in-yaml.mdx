...
### Disable dotenv debug mode

By default, Midscene will print the debug information of dotenv. If you don't want to see these information, you can use `--dotenv-debug` option.
...
By default, Midscene will use the global environment variables first. If you want to use the environment variables in the `.env` file instead, you can use `--dotenv-override` option.
