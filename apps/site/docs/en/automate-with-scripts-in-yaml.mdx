...
tasks:
  - name: <name>
    ...
    flow:
      ...
      # Wait for a positive duration in milliseconds. Records a Sleep step with its
      # requested and elapsed duration, without calling a model or taking screenshots.
      - sleep: <ms>
