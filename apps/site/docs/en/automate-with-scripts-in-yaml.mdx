...
agent:
  ...
  # Background knowledge sent with every AI-powered Agent API call, optional
...
- **globalContext**: Provides background knowledge shared by every AI-powered Agent API call. Per-call `context` is appended after it.
