...
- **aiActContext**: Provides background knowledge to the AI model, like how to handle popups, business introduction, etc. (`aiActionContext` is still supported for compatibility)
