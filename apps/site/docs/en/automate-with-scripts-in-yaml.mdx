  ...
  - name: <name>
    ...
    flow:
      ...
      - ai: <prompt>
        ...
        planningStrategy: 'fast' | 'standard' # Optional, planning mode. `fast` merges planning and locating for simple instructions; `standard` (default) separates them and includes the previous-step screenshot for better context.
