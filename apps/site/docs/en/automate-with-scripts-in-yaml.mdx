...
You can also run a yaml script with javascript by using the [`runYaml`](./api#runyamlyamlscriptcontent-string---run-a-yaml-script) method of the Midscene agent. Only the `tasks` part of the yaml script will be executed.
