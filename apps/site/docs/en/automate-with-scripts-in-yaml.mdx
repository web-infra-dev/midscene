  ...
  - name: <name>
    ...
    flow:
      ...
      - aiTap: <prompt>
        ...
        xpath: <xpath> # optional, the xpath of the element to tap. If provided, Midscene will skip the AI model and directly locate the element based on the xpath. Default: empty.
        cacheable: <boolean> # optional, whether cacheable when enabling [caching feature](./caching.mdx). True by default.
