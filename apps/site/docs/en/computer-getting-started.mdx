...
<PackageManagerTabs command="install build-essential libx11-dev libxtst-dev libpng-dev imagemagick" />
...
:::tip
ImageMagick is required for screenshot capture on Linux.
:::
...
On macOS, you need to grant accessibility permissions to your terminal application:

1. Open **System Preferences** → **Security & Privacy** → **Privacy** → **Accessibility**
2. Click the lock icon to make changes
3. Add your terminal app (Terminal.app, iTerm, VS Code, etc.)
...
Grant accessibility permissions to your terminal application in System Preferences.

### Linux: "spawn import ENOENT"
...
### Windows: Build errors during installation
