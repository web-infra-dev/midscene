...
- **Mouse Operations**: Click, double-click, right-click, hover, drag-and-drop
...
The automation adapts to platform differences:

- **macOS**: Cmd key, Spotlight (Cmd+Space), app switcher (Cmd+Tab)
- **Windows**: Windows key, Start menu, Alt+Tab
- **Linux**: Super key, application launcher
...
* [Use YAML format automation scripts](./automate-with-scripts-in-yaml) and [command-line tools](./command-line-tools)
