...
web:
  url: https://www.bing.com
+ cdpEndpoint: ws://localhost:9222/devtools/browser/<session-id>
```

:::tip
- Launch Chrome with `--remote-debugging-port=9222`, then visit `http://localhost:9222/json/version` to get the full WebSocket URL (including session ID).
