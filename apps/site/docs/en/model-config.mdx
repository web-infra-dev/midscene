...
| Name | Description |
|------|-------------|
| `MIDSCENE_MODEL_TIMEOUT` | Timeout for AI API calls in milliseconds. Defaults to OpenAI SDK default (10 minutes) |
...
const agent = new Agent(page, {
  // Set AI API timeout in milliseconds
  modelTimeout: 60000, // 60 seconds

  // Or configure via modelConfig
  modelConfig: {
