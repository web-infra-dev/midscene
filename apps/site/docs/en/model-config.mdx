...
| `MIDSCENE_MODEL_REASONING_EFFORT` | Reasoning effort for doubao-vision: `minimal` (no thinking), `low`, `medium`, `high`. When set, passes `reasoning_effort` to the model API |
