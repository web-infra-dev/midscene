...
export MIDSCENE_MODEL_FAMILY="gpt-5.4"
```
...
- `MIDSCENE_MODEL_FAMILY="gpt-5"` is still compatible, but it cannot use original resolution. See [model sizing behavior](https://developers.openai.com/api/docs/guides/images-vision#model-sizing-behavior)
