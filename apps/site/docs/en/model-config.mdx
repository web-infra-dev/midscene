...
This doc focuses on Midscene model configuration. For how we choose models, see [Model strategy](./model-strategy). For quick recipes for popular models, see [Supported models and setup](./model-common-config).
...
Set the `DEBUG` environment variable to one of the following selectors:
...
| `midscene:*` | Prints all debug logs |
