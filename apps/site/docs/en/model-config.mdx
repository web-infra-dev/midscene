...
| Name | Description |
|------|-------------|
| `MIDSCENE_MODEL_API_KEY` | Model API key for OpenAI-compatible HTTP providers, e.g., `"sk-abcd..."`. Not required when using [Codex App Server](./model-common-config#codex-app-server) |
