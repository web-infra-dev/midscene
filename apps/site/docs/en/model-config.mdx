...
```json
{"timestamp":"2026-08-05T10:00:00.000Z","type":"request","executionId":"execution_1","callId":"call_3","attempt":1,"request":{"url":"https://example.com/v1/chat/completions","method":"POST","body":"{\"model\":\"...\",\"messages\":[...],\"temperature\":0.2,\"stream\":true}"}}
{"timestamp":"2026-08-05T10:00:01.000Z","type":"chunk","executionId":"execution_1","callId":"call_3","attempt":1,"sequence":1,"chunk":{"choices":["..."]}}
{"timestamp":"2026-08-05T10:00:02.000Z","type":"response","executionId":"execution_1","callId":"call_3","attempt":1,"http":{"attempt":1,"status":200,"ok":true,"headers":[["x-request-id","req_..."]],"body":"{...}"},"final":{"content":"...","usage":{"total_tokens":123},"requestId":"req_...","timeCost":1234,"responseModelName":"..."}}
```

Every event includes `type` and `executionId`:
...
- `executionId` associates a model call with its report execution. Calls made within the same execution, including automatic retries, use the same `executionId`. Calls that are not included in a report execution, such as connectivity checks, use a generated ID prefixed with `fallback-`.
