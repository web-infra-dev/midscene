...
MIDSCENE_PLANNING_STYLE="doubao-vision"
```
...
MIDSCENE_PLANNING_STYLE="qwen-vl"
```
...
MIDSCENE_PLANNING_STYLE="gemini"
```
...
MIDSCENE_PLANNING_STYLE="vlm-ui-tars-doubao-1.5"
```

**About `MIDSCENE_PLANNING_STYLE`**
...
:::tip
The legacy configurations `MIDSCENE_USE_VLM_UI_TARS=DOUBAO` or `MIDSCENE_USE_VLM_UI_TARS=1.5` are still supported but deprecated. Please migrate to `MIDSCENE_PLANNING_STYLE`.

Migration mapping:
- `MIDSCENE_USE_VLM_UI_TARS=1.0` → `MIDSCENE_PLANNING_STYLE="vlm-ui-tars"`
- `MIDSCENE_USE_VLM_UI_TARS=1.5` → `MIDSCENE_PLANNING_STYLE="vlm-ui-tars-doubao-1.5"`
- `MIDSCENE_USE_VLM_UI_TARS=DOUBAO` → `MIDSCENE_PLANNING_STYLE="vlm-ui-tars-doubao"`
:::
...
|------|-------------|--------------|
| `MIDSCENE_USE_DOUBAO_VISION` | Deprecated. Enables Doubao vision model | Use `MIDSCENE_PLANNING_STYLE="doubao-vision"` |
| `MIDSCENE_USE_QWEN3_VL` | Deprecated. Enables Qwen3-VL model | Use `MIDSCENE_PLANNING_STYLE="qwen3-vl"` |
| `MIDSCENE_USE_QWEN_VL` | Deprecated. Enables Qwen2.5-VL model | Use `MIDSCENE_PLANNING_STYLE="qwen-vl"` |
| `MIDSCENE_USE_GEMINI` | Deprecated. Enables Gemini model | Use `MIDSCENE_PLANNING_STYLE="gemini"` |
| `MIDSCENE_USE_VLM_UI_TARS` | Deprecated. Enables UI-TARS model | Use `MIDSCENE_PLANNING_STYLE="vlm-ui-tars*"` |
