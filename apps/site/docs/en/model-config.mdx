...
In this article, we will show you how to config AI service provider and how to choose a different model. You may read [Model strategy](./model-strategy) first to learn more about how to choose a model.
...
For more information about the models, see [Model strategy](./model-strategy).
