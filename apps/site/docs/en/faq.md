...
Please refer to [Model strategy](./model-strategy).
...
2. Use a dedicated model and deploy it yourself, like UI-TARS. This is the recommended way. Read more about it in [Model strategy](./model-strategy).
