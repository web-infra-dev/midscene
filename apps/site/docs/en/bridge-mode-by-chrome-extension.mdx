...
```typescript
import { ChromePageOverBridgeAgent } from "@midscene/web/bridge-mode";
...
Except [the normal agent interface](./api), `ChromePageOverBridgeAgent` provides some other interfaces to control the desktop Chrome.
