...
[JavaScript demo project](https://github.com/web-infra-dev/midscene-example/blob/main/android-demo/README.md)
...
[Vitest demo project](https://github.com/web-infra-dev/midscene-example/blob/main/android-with-vitest-demo/README.md)
