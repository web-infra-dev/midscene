...
* Parameters:
  ...
  * `options?: Object` - Optional, a configuration object containing:
    * `domIncluded?: boolean` - Whether to include DOM structure, usually used for querying invisible attributes like image links. Default: False
    * `screenshotIncluded?: boolean` - Whether to include screenshot. Default: True.
...
// Use domIncluded feature to query invisible attributes
