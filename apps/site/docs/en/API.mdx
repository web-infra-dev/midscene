...
* `waitForNetworkIdleTimeout: number`: The timeout for waiting for network idle. (Default: 2000ms)
* `waitForNavigationTimeout: number`: The timeout for waiting for navigation. (Default: 5000ms)
