...
- `customActions` configures additional actions on `AndroidDevice`. Pass it to the Device constructor or to `agentFromAdbDevice()`.
...
- Use one agent per device connection.
- `customActions` configures additional actions on `IOSDevice`. Pass it to the Device constructor or to `agentFromWebDriverAgent()`.
...
- Use one Agent per device connection.
- `customActions` configures additional actions on `HarmonyDevice`. Pass it to the Device constructor or to `agentFromHdcDevice()`.
