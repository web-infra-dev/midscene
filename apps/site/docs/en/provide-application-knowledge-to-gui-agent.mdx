...
### Provide only a vague test goal
...
### Describe actions with fixed coordinates and pixel distances
...
### Write every tap and wait as a separate instruction
...
### Inject the entire app knowledge base into every Case
...
### Invent operation paths without checking the interface
