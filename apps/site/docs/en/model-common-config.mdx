...
Using Alibaba Cloud's `qwen3.5-vl-plus` as an example:
...
Qwen3.5 behaves the same as Qwen3-VL at runtime. You can also use Qwen3.5 from [OpenRouter](https://openrouter.ai/qwen).
