...
### Gemini Series {#gemini-3-pro}

Among Gemini models, `gemini-3.5-flash` currently has the best localization performance in our private evaluation set. After requesting an API key from [Google Gemini](https://gemini.google.com/), use this configuration.

Set `MIDSCENE_MODEL_NAME` to the specific Gemini model name you use:

```bash
MIDSCENE_MODEL_BASE_URL="https://generativelanguage.googleapis.com/v1beta/openai/"
MIDSCENE_MODEL_API_KEY="......"
MIDSCENE_MODEL_NAME="gemini-3.5-flash" # Or a specific Gemini model name
