import { ModelConfigCard, PackageManagerTabs } from '@theme';
...
<ModelConfigCard
  baseUrl={{
    ...
    comment: "Volcano Engine endpoint",
  }}
...
<ModelConfigCard
  baseUrl={{
    ...
    comment: "Alibaba Cloud endpoint",
  }}
  modelName="qwen3.7-plus"
  modelFamily={{
    value: "qwen3",
    comment: "If you use another Qwen version, replace this with the corresponding model family",
  }}
/>
...
<ModelConfigCard
  baseUrl={{
    ...
    comment: "Google Gemini API endpoint",
  }}
...
<ModelConfigCard
  baseUrl={{
    ...
    comment: "OpenAI API endpoint; or your compatible endpoint",
  }}
  modelName="gpt-6-sol"
  modelFamily="gpt-6"
  responses
...
<ModelConfigCard
  baseUrl={{
    ...
    comment: "Moonshot AI API endpoint",
  }}
  modelName="kimi-k3"
  modelFamily={{
    value: "kimi3",
    comment: "For kimi-k2.6, use \"kimi\"",
  }}
/>
...
<ModelConfigCard
  baseUrl={{
    ...
    comment: "Xiaomi MiMo API endpoint",
  }}
  modelName="mimo-v2.6-pro"
  modelFamily="xiaomi-mimo"
/>
...
<ModelConfigCard
  baseUrl={{
    ...
    comment: "BigModel API endpoint; use https://api.z.ai/api/paas/v4 for Z.AI",
  }}
