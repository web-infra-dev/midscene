...
After requesting an API key from [Google Gemini](https://gemini.google.com/), configure. Use your specific Gemini-3-Flash release name for `MIDSCENE_MODEL_NAME`:

```bash
MIDSCENE_MODEL_BASE_URL="https://generativelanguage.googleapis.com/v1beta/openai/"
MIDSCENE_MODEL_API_KEY="......"
MIDSCENE_MODEL_NAME="gemini-3-flash" # Or a specific Gemini-3-Flash release name
