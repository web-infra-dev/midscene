...
To start a new project, use [`midscene-test create`](./extend-test-runner#create-a-project). It generates platform configuration, example cases, and `midscene-nodes.md` in one command.
