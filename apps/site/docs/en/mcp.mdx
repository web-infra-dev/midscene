...
### Using the simplified launcher API

For a more convenient way to start MCP servers, each platform provides a `mcpServerForAgent` function that handles the wiring between agents, tools managers, and MCP servers automatically.
