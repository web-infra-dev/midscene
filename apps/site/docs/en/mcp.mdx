...
const kit = await mcpKitForAgent(agent);

console.log(kit.description); // "Midscene MCP Kit for Web automation (Bridge mode)"
console.log(kit.tools); // Tool[] - array of tool definitions
```
