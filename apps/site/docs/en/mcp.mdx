...
1. An OpenAI API key or another supported AI model provider. For more information, see [Model selection](./model-selection).
...
For more information about configuring AI models, see [Model selection](./model-selection).
