...
- Read [Provide application knowledge to a GUI Agent](../provide-application-knowledge-to-gui-agent) to learn how to supply relevant application knowledge and help a GUI Agent execute tasks more reliably.
