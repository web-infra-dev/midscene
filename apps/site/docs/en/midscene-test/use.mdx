...
| Selector | Target |
| --- | --- |
| `first` | First executed Step |
| `last` | Last executed Step |
| `first-error` | First failed Step, including failed retry attempts |
| `last-error` | Last failed Step, including failed retry attempts |
