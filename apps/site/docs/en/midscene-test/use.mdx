...
You can also select Cases by stable ID or tags. Repeated options are combined: IDs are matched exactly, included tags use OR matching, and excluded tags always remove a Case.
