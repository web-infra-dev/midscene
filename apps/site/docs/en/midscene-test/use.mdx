...
Project setup manages browser and Agent resources; see [Manage project resources](./configuration#manage-project-resources). For resources created inside a Node, see [Resource lifecycle and cleanup](./extend#resource-lifecycle-and-cleanup).
