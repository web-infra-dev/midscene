...
There are several ways to experience or integrate with Midscene:

* [The Chrome Extension](./quick-experience): quickly experience the main features of Midscene on any webpage, without needing to set up a code project.
