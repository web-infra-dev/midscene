...
![bridge mode](/images/midscene-bridge-mode.png)
...
<p align="center">
  <img src="/images/bridge_in_extension.png" alt="bridge in extension" width="400"/>
</p>
...
<p align="center">
  <img src="/images/bridge_remote_config.png" alt="bridge remote config" width="400"/>
</p>
...
When using bridge mode, configure the model parameters in the terminal. For supported models and setup examples, see [Supported models and setup](./model-common-config).

## More

- For every Agent method, check the [API reference](./reference/#interaction-methods).
- For the full Chrome Bridge API surface, see [API reference (Web)](./reference/#chrome-bridge-agent).
- Demo project
