...
:::tip Auto-connect in background

Enable the **Auto-connect in background** toggle to keep listening for connection requests even without opening the sidebar. The extension icon will display a status badge: yellow dot for listening, green dot for connected.
