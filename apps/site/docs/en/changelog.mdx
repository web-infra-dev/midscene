...
The biggest highlight of v0.29 is the official introduction of iOS platform support! Now you can connect and automate iOS devices through WebDriver, extending Midscene's powerful AI automation capabilities to the Apple ecosystem.

### 🤖 AI Core Capability Enhancement
- **Qwen3-VL Model Adaptation**: We've adapted the latest Qwen `Qwen3-VL` model, further improving the accuracy and efficiency of visual understanding
