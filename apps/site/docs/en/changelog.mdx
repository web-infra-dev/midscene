...
v1.12 adds DeepSeek V4 vision model support, introduces Midscene Test (Beta), and adds timing summaries to reports.
...
- Added `@midscene/test` for natural-language tests in YAML with TypeScript Node extensions. Midscene Test will gradually replace the legacy YAML automation solution; its protocol and APIs remain in Beta. See the [Midscene Test overview](./midscene-test/overview).
...
![](/images/blog/0.6.0.png)

> after

![](/images/blog/0.6.0-2.png)
...
![](/images/blog/0.6.0-3.png)

![](/images/blog/0.6.0-4.png)
...
![](/images/blog/0.6.0-5.png)

> after

![](/images/blog/0.6.0-6.png)
