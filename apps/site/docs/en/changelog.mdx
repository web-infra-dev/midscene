...
## v1.9 - Studio Recorder, Markdown Replay & Harmony YAML Target

The v1.9 release brings Studio recorder support, Markdown replay output, HarmonyOS YAML automation, and a set of CLI, report, model, and desktop automation fixes. The current latest release is available from [GitHub Releases](https://github.com/web-infra-dev/midscene/releases/latest), which automatically redirects to the latest tag.

### Midscene Studio Beta Recorder

Midscene Studio remains in **Beta**. Download it from the [latest release page](https://github.com/web-infra-dev/midscene/releases/latest) by choosing a `midscene-studio-beta-*` asset. Direct beta installer links: [macOS Apple Silicon DMG](https://github.com/web-infra-dev/midscene/releases/download/v1.9.2/midscene-studio-beta-v1.9.2-darwin-arm64.dmg), [Windows x64 ZIP](https://github.com/web-infra-dev/midscene/releases/download/v1.9.2/midscene-studio-beta-v1.9.2-win32-x64.zip), [Linux x64 ZIP](https://github.com/web-infra-dev/midscene/releases/download/v1.9.2/midscene-studio-beta-v1.9.2-linux-x64.zip).
