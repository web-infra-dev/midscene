...
See documentation: [Scrcpy Screenshot Mode](./android#scrcpy)
...
- New keyboard hiding strategy([keyboardDismissStrategy](./android#androiddevice)), allowing you to specify the way to automatically hide the keyboard
...
* [API documentation for more Android configuration items](/en/android#androiddevice)
