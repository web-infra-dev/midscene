...
- **Screen info cache control**: Use `alwaysFetchScreenInfo` option to control whether to fetch screen information each time, allowing cache reuse in stable environments to improve performance
