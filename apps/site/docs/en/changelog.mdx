...
## v1.9 - Markdown Replay and Automation Fixes

The v1.9 release brings Markdown replay output, HarmonyOS YAML automation, and a set of CLI, report, model, and desktop automation fixes. The current latest release is available from [GitHub Releases](https://github.com/web-infra-dev/midscene/releases/latest), which automatically redirects to the latest tag.
