...
## v0.24 - 🤖 Android Toolchain Support MCP Call

### 🚀 Android Toolchain Support MCP Call
- Android toolchain has fully supported MCP call, providing a more complete set of automation testing tools for Android developers
...
- Optimize development workflow, just execute npm run dev to enter midscene project development
