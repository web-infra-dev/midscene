...
* [Qwen3-VL or Qwen2.5-VL](#qwen3-vl-or-qwen-25-vl)
...
### Doubao visual-language models (✨ recommended)

Volcano Engine provides multiple visual-language models, including:
* `Doubao-1.5-thinking-vision-pro`
* `Doubao-seed-1.6-vision`

They perform strongly for visual grounding and assertion in complex scenarios. With clear instructions they can handle most business needs, and they are currently the most recommended visual-language models for Midscene.
