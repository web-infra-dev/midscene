...
| Gemini 3.x Series<br />[Quick setup](./model-common-config#gemini-3-pro) | [Google Cloud](https://ai.google.dev/gemini-api/docs/models/gemini) | ⭐⭐⭐⭐⭐<br />`gemini-3.5-flash` has the best localization performance in our private evaluation set<br />Price is higher than Doubao and Qwen |
...
The `deepThink` option controls how strongly Midscene guides `aiAct` to think during planning.
