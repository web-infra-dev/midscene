...
Explicit reasoning configuration requires a supported `MIDSCENE_MODEL_FAMILY`. If the model family is missing or unsupported, Midscene will throw an error instead of guessing provider-specific reasoning parameters.
