...
| Gemini-3-Pro<br />[Quick setup](./model-config.mdx#gemini-3-pro) | [Google Cloud](https://ai.google.dev/gemini-api/docs/models/gemini) | ⭐⭐⭐<br />UI grounding accuracy trails Doubao and Qwen |
...
The default model strategy covers most projects at kick-off. As prompts grow more complex and you need stronger generalization, the defaults can struggle. Consider this GitHub sign-up prompt:
