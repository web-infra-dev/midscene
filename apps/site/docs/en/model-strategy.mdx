...
| GPT-5.4<br />[Quick setup](./model-common-config#gpt-5-4) | [OpenAI](https://platform.openai.com/) | ⭐⭐⭐<br />Visual grounding is unstable; recommended as a Planning model<br />[Codex App Server](./model-common-config#codex-app-server) supported |
