...
* [Gemini Series](./model-common-config#gemini-3-pro)
...
Based on extensive real-world usage, we recommend these defaults for Midscene: Doubao Seed, Qwen3.x, Zhipu GLM-V, Zhipu AutoGLM, and the Gemini series.
...
| Gemini Series<br />[Quick setup](./model-common-config#gemini-3-pro) | [Google Cloud](https://ai.google.dev/gemini-api/docs/models/gemini) | ⭐⭐⭐<br />`gemini-3.5-flash` has the best localization performance in our private evaluation set<br />Price is higher than Doubao and Qwen |
