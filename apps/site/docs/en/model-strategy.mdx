...
* [Qwen3.5](./model-common-config#qwen35)
...
| Qwen3.5<br />[Quick setup](./model-common-config#qwen35) | [Alibaba Cloud](https://help.aliyun.com/zh/model-studio/vision)<br/>[OpenRouter](https://openrouter.ai/qwen) | ⭐⭐⭐⭐<br />Behaves the same as Qwen3-VL |
...
The `deepThink` option controls whether models use deep reasoning during planning. Currently supported for `qwen3-vl`, `qwen3.5`, `doubao-seed-1.6` and `glm-v` model families.
...
- `qwen3-vl` / `qwen3.5` on Alibaba Cloud: disabled by default (faster, less accurate)
