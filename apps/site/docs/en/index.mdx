...
## Support both multimodal LLM and open-source model

Midscene supports both multimodal LLM and open-source model. You can use the multimodal LLM like `gpt-4o` as the default model, it works well for most cases. 
