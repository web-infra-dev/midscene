...
export default function MainContent() {
  return (
    <div className="relative flex h-full min-h-0 min-w-0 flex-1 flex-col overflow-hidden rounded-l-[12px] border-r border-[#ECECEC] bg-white">
      <div
        className="flex h-[52px] items-center pl-[8px] pr-4"
        data-reference-id="7780:178138"
      >
        <div className="flex items-center">
          ...
          <span
            className="ml-[8px] w-[134px] overflow-hidden whitespace-nowrap text-[13px] leading-[22.1px] font-medium text-[#0D0D0D]"
            data-reference-id="7780:178144"
          >
            三星 Galaxy S26 Ultra
          </span>
          <div className="ml-[8px] flex h-[28px] items-center gap-[8.04px] rounded-[16.07px] bg-[#E5FFF4] px-[10px]">
            ...
            <span
              className="text-[12.1px] leading-[12.1px] font-medium text-[#079669]"
              data-reference-id="7780:183699"
            >
              Live
            </span>
          </div>
