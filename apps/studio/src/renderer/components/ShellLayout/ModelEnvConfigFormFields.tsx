...
function ModelEnvConfigFormItem({
  ...
  return (
    <div className="flex h-[61px] w-full flex-col overflow-visible">
      <div
        aria-hidden="true"
        className="mb-[8px] h-[20px] w-full overflow-hidden whitespace-nowrap font-['Inter'] text-[14px] font-normal leading-[19.6px] text-black/90"
      >
        {label}
      </div>
      <div className="box-border flex h-[36px] px-[12px] w-full items-center justify-between rounded-[8px] border border-[#EFEFEE] bg-white">
        <input
          ...
          className="h-[17px] w-full flex-1 overflow-hidden whitespace-nowrap border-0 bg-transparent font-['Inter'] text-[14px] font-normal leading-[16.9px] text-black outline-none placeholder:text-black/35"
