...
export interface RecorderArchiveTextEntry {
  archivePath: string;
  content: string;
}

export interface RecorderArchiveAssetEntry {
  archivePath: string;
  assetId: string;
  mimeType: string;
  bytes: number;
...
export interface RecorderArchiveProgress {
  jobId: string;
...
export interface ElectronShellApi {
  ...
  /** Stream a recorder ZIP from text plus run-directory screenshot assets. */
