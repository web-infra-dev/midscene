...
describe('ScreenshotItem', () => {
  ...
  describe('fromSerializedData', () => {
    it('should deserialize from object with base64 property', () => {
  ...
  describe('isSerializedData', () => {
    it('should return true for objects with non-empty base64 string', () => {
    ...
    it('should return false for objects with empty base64 string', () => {
      expect(ScreenshotItem.isSerializedData({ base64: '' })).toBe(false);
    });

    it('should return false for plain strings (old format)', () => {
      expect(ScreenshotItem.isSerializedData(testBase64)).toBe(false);
      expect(ScreenshotItem.isSerializedData('any-string')).toBe(false);
    });
