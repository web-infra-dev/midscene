...
- For continuous controls that set a value along a track, such as a slider on touch or desktop interfaces, prefer Swipe from the current handle or filled position to the requested track endpoint instead of tapping the endpoint.
