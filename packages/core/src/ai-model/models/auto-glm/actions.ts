...
/**
 * Convert auto-glm coordinate [0,1000] to bbox in actual pixel coordinates
 */
function autoGLMCoordinateToBbox(
  ...
  const bbox = expandNormalized01000PointToBbox(x, y, 10);
  return mapNormalized01000XyxyToActualPixelBbox(bbox, width, height);
}
