...
// TODO: envNames.reduce((p, name) => ({...p, name: process.env[name]}),Object.create(null))
export const allConfigFromEnv = () => {
  return {
    ...
    // VQA
    [MIDSCENE_VQA_MODEL_NAME]: process.env[MIDSCENE_VQA_MODEL_NAME],
    [MIDSCENE_VQA_OPENAI_SOCKS_PROXY]:
      process.env[MIDSCENE_VQA_OPENAI_SOCKS_PROXY],
    [MIDSCENE_VQA_OPENAI_HTTP_PROXY]:
      process.env[MIDSCENE_VQA_OPENAI_HTTP_PROXY],
    [MIDSCENE_VQA_OPENAI_BASE_URL]: process.env[MIDSCENE_VQA_OPENAI_BASE_URL],
    [MIDSCENE_VQA_OPENAI_API_KEY]: process.env[MIDSCENE_VQA_OPENAI_API_KEY],
    [MIDSCENE_VQA_OPENAI_INIT_CONFIG_JSON]:
      process.env[MIDSCENE_VQA_OPENAI_INIT_CONFIG_JSON],
    [MIDSCENE_VQA_OPENAI_USE_AZURE]: process.env[MIDSCENE_VQA_OPENAI_USE_AZURE],
    [MIDSCENE_VQA_USE_AZURE_OPENAI]: process.env[MIDSCENE_VQA_USE_AZURE_OPENAI],
    [MIDSCENE_VQA_AZURE_OPENAI_SCOPE]:
      process.env[MIDSCENE_VQA_AZURE_OPENAI_SCOPE],
    [MIDSCENE_VQA_AZURE_OPENAI_KEY]: process.env[MIDSCENE_VQA_AZURE_OPENAI_KEY],
    [MIDSCENE_VQA_AZURE_OPENAI_ENDPOINT]:
      process.env[MIDSCENE_VQA_AZURE_OPENAI_ENDPOINT],
    [MIDSCENE_VQA_AZURE_OPENAI_API_VERSION]:
      process.env[MIDSCENE_VQA_AZURE_OPENAI_API_VERSION],
    [MIDSCENE_VQA_AZURE_OPENAI_DEPLOYMENT]:
      process.env[MIDSCENE_VQA_AZURE_OPENAI_DEPLOYMENT],
    [MIDSCENE_VQA_AZURE_OPENAI_INIT_CONFIG_JSON]:
      process.env[MIDSCENE_VQA_AZURE_OPENAI_INIT_CONFIG_JSON],
    [MIDSCENE_VQA_USE_ANTHROPIC_SDK]:
      process.env[MIDSCENE_VQA_USE_ANTHROPIC_SDK],
    [MIDSCENE_VQA_ANTHROPIC_API_KEY]:
      process.env[MIDSCENE_VQA_ANTHROPIC_API_KEY],
  };
};
