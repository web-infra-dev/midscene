...
export const MIDSCENE_MCP_USE_ANDROID_MODE = 'MIDSCENE_MCP_USE_ANDROID_MODE';
...
export const allConfigFromEnv = () => {
  return {
    [MIDSCENE_MCP_USE_ANDROID_MODE]: process.env[MIDSCENE_MCP_USE_ANDROID_MODE] || undefined,
    [MIDSCENE_OPENAI_INIT_CONFIG_JSON]:
