...
export const MIDSCENE_PLANNING_MEMORY = 'MIDSCENE_PLANNING_MEMORY';
export const MIDSCENE_PLANNING_LOG = 'MIDSCENE_PLANNING_LOG';
export const MIDSCENE_PLANNING_TASK_SCOPE = 'MIDSCENE_PLANNING_TASK_SCOPE';
export const MIDSCENE_PLANNING_SCREENSHOT_COUNT =
  'MIDSCENE_PLANNING_SCREENSHOT_COUNT';

export const MIDSCENE_PLANNING_SEPARATE_LOCATE =
...
export const STRING_ENV_KEYS = [
  ...
  MIDSCENE_PLANNING_SCREENSHOT_COUNT,
  // Preserve the unset state so aiAct can retain its default locate strategy.
  MIDSCENE_PLANNING_SEPARATE_LOCATE,
  MIDSCENE_ADB_PATH,
