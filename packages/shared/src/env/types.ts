import type { ModelInputImageCapabilities } from '../img/model-input';
...
export const MIDSCENE_MODEL_IMAGE_INPUT_CONFIG_JSON =
...
export const MIDSCENE_INSIGHT_MODEL_IMAGE_INPUT_CONFIG_JSON =
  'MIDSCENE_INSIGHT_MODEL_IMAGE_INPUT_CONFIG_JSON';
...
export const MIDSCENE_PLANNING_MODEL_IMAGE_INPUT_CONFIG_JSON =
  'MIDSCENE_PLANNING_MODEL_IMAGE_INPUT_CONFIG_JSON';
...
export interface IModelConfigForInsight {
  ...
  [MIDSCENE_INSIGHT_MODEL_IMAGE_INPUT_CONFIG_JSON]?: string;
  // timeout
...
export interface IModelConfigForPlanning {
  ...
  [MIDSCENE_PLANNING_MODEL_IMAGE_INPUT_CONFIG_JSON]?: string;
  // timeout
...
export interface IModelConfigForDefault {
  ...
  [MIDSCENE_MODEL_IMAGE_INPUT_CONFIG_JSON]?: string;
  // extra
...
export interface IModelConfig {
  ...
  /** Provider-specific image limits applied before model requests. */
  imageInput?: ModelInputImageCapabilities;
  /**
