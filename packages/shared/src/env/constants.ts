...
export const INSIGHT_MODEL_CONFIG_KEYS: IModelConfigKeys = {
  ...
  imageInput: MIDSCENE_INSIGHT_MODEL_IMAGE_INPUT_CONFIG_JSON,
  /**
   * Extra
   */
...
export const PLANNING_MODEL_CONFIG_KEYS: IModelConfigKeys = {
  ...
  imageInput: MIDSCENE_PLANNING_MODEL_IMAGE_INPUT_CONFIG_JSON,
  /**
   * Extra
   */
...
export const DEFAULT_MODEL_CONFIG_KEYS: IModelConfigKeys = {
  ...
  imageInput: MIDSCENE_MODEL_IMAGE_INPUT_CONFIG_JSON,
  /**
   * Extra
   */
