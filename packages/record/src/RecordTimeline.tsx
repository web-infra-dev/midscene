                                                        ...
                                                        <Space direction="vertical" size="middle" style={{ width: '100%' }}>
                                                            ...
                                                            {hasElementInfo && (
                                                                <div style={{
                                                                    ...
                                                                    <Text type="secondary">
                                                                        元素位置: ({event.viewportX}, {event.viewportY}) |
                                                                        尺寸: {event.width} × {event.height}px
                                                                        {event.pageWidth && event.pageHeight && (
                                                                            <> | 页面: {event.pageWidth} × {event.pageHeight}px</>
                                                                        )}
                                                                    </Text>
                                                                </div>
                                                            )}
                                                ...
                                                <div style={{ maxWidth: '400px' }}>
                                                    <Space direction="vertical" size="small" style={{ width: '100%' }}>
                                                        ...
                                                        <div style={{
                                                            ...
                                                            <div><Text strong>元素类型:</Text> {event.targetTagName || 'Unknown'}</div>
                                                            <div><Text strong>操作:</Text> {event.type}</div>
                                                            <div><Text strong>位置:</Text> ({event.viewportX}, {event.viewportY})</div>
                                                            <div><Text strong>尺寸:</Text> {event.width} × {event.height}px</div>
                                                            {event.pageWidth && event.pageHeight && (
                                                                <div><Text strong>页面尺寸:</Text> {event.pageWidth} × {event.pageHeight}px</div>
                                                            )}
                                                            {event.value && <div><Text strong>内容:</Text> "{event.value}"</div>}
                                                        </div>
                                                    </Space>
                                                </div>
                                            }
            ...
            <Space direction="vertical" size="large" style={{ width: '100%' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <Space>
                        ...
                        <Text type="secondary" style={{ fontSize: '12px' }}>
                            ({events.filter(e => e.viewportX !== undefined).length} 个事件已标注元素)
                        </Text>
                    </Space>
                </div>
