...
test.describe('ai todo describe', () => {
  ...
  test('ai todo', async ({ ai, aiQuery, page }) => {
    ...
    const expectedActiveTasks = [
      'Learn JS today',
      'Learn Rust tomorrow',
      'Learning Python the day after tomorrow',
    ] as const;
    ...
    await ai(
      'Type "Learning Python the day after tomorrow" in the task box, then press Enter to create',
    );
    ...
    expect(allTaskList).toContain('Learning Python the day after tomorrow');
    ...
    await ai(
      'Click the checkbox next to "Learning Python the day after tomorrow"',
    );
    ...
    expect(taskList).toContain('Learning Python the day after tomorrow');
