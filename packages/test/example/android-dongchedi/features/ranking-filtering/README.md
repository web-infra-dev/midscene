...
生成产物是 [ranking-filtering.yaml](../../cases/ranking-filtering.yaml)。价格调整场景的截图、Context 定义和两种组织方式集中写在 [从应用知识到测试用例](https://midscenejs.com/zh/from-application-knowledge-to-test-cases)，这里不再重复。
