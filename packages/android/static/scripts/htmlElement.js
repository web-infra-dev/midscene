var midscene_element_inspector = (() => {
      ...
      if ((n && 'object' == typeof n) || 'function' == typeof n)
        for (const h of o(n))
          s.call(e, h) ||
            ...
            t(e, h, {
              get: () => n[h],
              enumerable: !(a = r(n, h)) || a.enumerable,
            });
      return e;
    },
    m = u({
    ...
    b = u({
      '../../node_modules/.pnpm/js-sha256@0.11.0/node_modules/js-sha256/src/sha256.js'(
        ...
        !(() => {
          ...
          o ? (r = global) : i && (r = self);
          var a =
              !r.JS_SHA256_NO_COMMON_JS && 'object' == typeof t && t.exports,
            h = 'function' == typeof define && define.amd,
            s =
              !r.JS_SHA256_NO_ARRAY_BUFFER && 'undefined' != typeof ArrayBuffer,
            l = '0123456789abcdef'.split(''),
            d = [-0x80000000, 8388608, 32768, 128],
            c = [24, 16, 8, 0],
            f = [
          ...
          var b = (e, t) => (n) => new w(t, !0).update(n)[e](),
            y = (e) => {
              var t = b('hex', e);
              o && (t = g(t, e)),
                (t.create = () => new w(e)),
            ...
            g = (t, n) => {
              ...
              return (
                ...
                (n) => {
                  if ('string' == typeof n)
                    return o.createHash(h).update(n, 'utf8').digest('hex');
                  ...
                  return (
                    ...
                    n.constructor === a
                      ? o.createHash(h).update(i(n)).digest('hex')
                      : t(n)
                  );
                }
              );
            },
            x = (e, t) => (n, r) => new T(n, t, !0).update(r)[e](),
            N = (e) => {
              var t = x('hex', e);
          ...
          function T(t, n, r) {
            ...
            t.length > 64 && (t = new w(n, !0).update(t).array());
            var c = [],
              f = [];
            for (i = 0; i < 64; ++i) {
              var u = t[i] || 0;
          ...
          (w.prototype.update = function (t) {
            if (!this.finalized) {
              ...
              for (var i, o, a = 0, h = t.length, l = this.blocks; a < h; ) {
                if (
                  (this.hashed &&
                    ((this.hashed = !1),
                    (l[0] = this.block),
              ...
              for (e = 16; e < 64; ++e)
                (t =
                  ...
                  (n =
                    ...
                    ((i >>> 19) | (i << 13)) ^
                    (i >>> 10)),
                  (N[e] = (N[e - 16] + t + N[e - 7] + n) << 0);
              for (e = 0, d = u & p; e < 64; e += 4)
                this.first
                  ? (this.is224
                      ? ((h = 300032),
                        (x = ((i = N[0] - 0x543c9a5b) - 0x8f1a6c7) << 0),
                        (m = (i + 0x170e9b5) << 0))
                      : ((h = 0x2a01a605),
                        (x = ((i = N[0] - 0xc881298) - 0x5ab00ac6) << 0),
                        (m = (i + 0x8909ae5) << 0)),
                    (this.first = !1))
                  : ((t =
                      ((c >>> 2) | (c << 30)) ^
  ...
  function g(e, t = 150) {
    return void 0 === e
      ? ''
      : ('object' == typeof e && (e = JSON.stringify(e)), 'number' == typeof e)
        ? e.toString()
...
${n}`);
      ...
      if (
        i.node &&
        i.node.rect.width > 4 &&
        i.node.rect.height > 4 &&
        (!n || (n && i.node.content))
      ) {
        let e;
        (c = !1),
          (e = (null == (a = i.node.attributes) ? void 0 : a.htmlTagName)
            ? i.node.attributes.htmlTagName.replace(/[<>]/g, '')
            : i.node.attributes.nodeType.replace(/\sNode$/, '').toLowerCase());
        const n = i.node.indexId,
          o = n ? `markerId="${n}"` : '',
          u = i.node.rect
            ? {
                left: i.node.rect.left,
                top: i.node.rect.top,
                width: i.node.rect.width,
                height: i.node.rect.height,
              }
            : {};
        s = `<${e} id="${i.node.id}" ${o} ${r(
          ((h = i.node.attributes || {}),
          Object.keys(h).reduce((e, n) => {
            const r = h[n];
            return (
              'style' === n ||
                'src' === n ||
...
${f}${d}`;
  ...
  function N(e) {
    ...
    return (
      !(function e(n) {
        for (const r of (n.node && t.push(n.node), n.children)) e(r);
      })(e),
      t
    );
  }
  function w(e, t) {
    return (
      !(function e(n) {
        for (const r of (n.node && (n.node = t(n.node)), n.children)) e(r);
      })(e),
      e
    );
  }
  ...
  ((e, n) => {
    ...
    clientExtractTextWithPosition: () => R,
    descriptionOfTree: () => x,
    traverseTree: () => w,
    treeToList: () => N,
    webExtractNodeTree: () => U,
    webExtractNodeTreeAsString: () => z,
    webExtractTextWithPosition: () => k,
  });
  var v = ((n, r, i) => (
      (i = null != n ? e(h(n)) : {}),
      p(
        n && n.__esModule ? i : t(i, 'default', { value: n, enumerable: !0 }),
        n,
      )
    ))(b()),
    M = {},
  ...
  var C = '_midscene_retrieve_task_id';
  function _(e, t, n, r) {
    if (!(e instanceof r.HTMLElement)) return '';
    if (!C) return console.error('No task id found'), '';
    const i = `[${C}='${t}']`;
    return (
      A &&
        (n
          ? e.parentNode instanceof r.HTMLElement &&
            e.parentNode.setAttribute(C, t.toString())
          : e.setAttribute(C, t.toString())),
      i
    );
  }
  function S(e, t) {
  ...
  function H(e, t, n) {
    ...
    if (e instanceof n.HTMLElement)
      (r = e.getBoundingClientRect()),
        'currentCSSZoom' in e ||
          (i = Number.parseFloat(n.getComputedStyle(e).zoom) || 1);
    else {
      const t = n.document.createRange();
      t.selectNodeContents(e), (r = t.getBoundingClientRect());
    }
    const o = i * t;
    return {
      width: r.width * o,
  ...
  var L = (e, t, n) => {
    const r = t.left + t.width / 2,
      i = t.top + t.height / 2,
      o = n.document.elementFromPoint(r, i);
    return (
      !(
        !o ||
        o === e ||
      ...
      !!S(t, H(o, 1, n)) &&
      (O(e, 'Element is covered by another element', {
        topElement: o,
        el: e,
        rect: t,
        x: r,
  ...
  function W(e, t, n, r = 1, i = { left: 0, top: 0 }) {
    var o;
    const a = ((e, t, n, r = 1) => {
      if (
        !e ||
        ...
        return O(e, 'Element is not in the DOM hierarchy'), !1;
      if (e instanceof t.HTMLElement) {
        ...
        if (
          ...
          return O(e, 'Element is hidden'), !1;
      }
      const i = H(e, r, t);
      if (0 === i.width && 0 === i.height)
        return O(e, 'Element has no size'), !1;
      if (1 === r && L(e, i, t)) return !1;
      const o = t.pageXOffset || n.documentElement.scrollLeft,
        a = t.pageYOffset || n.documentElement.scrollTop,
        h = t.innerWidth || n.documentElement.clientWidth,
      ...
      if (
        !((e, t, n) => {
          ...
          return !!o && (o.width * o.height) / (r * i) >= 2 / 3;
        })(i, t, n)
      )
        return (
          O(e, 'Element is completely outside the viewport', {
            rect: i,
            viewportHeight: s,
            viewportWidth: h,
            scrollTop: a,
      ...
      while (l && l !== n.body) {
        ...
        if ('hidden' === n.overflow) {
          ...
          if (
            ...
            return (
              O(e, 'element is partially or totally hidden by an ancestor', {
                rect: i,
                parentRect: n,
              }),
              !1
        ...
        l = 'absolute' === n.position ? d(l) : l.parentElement;
      }
      return {
    ...
    if (
      ...
      a.width < 3 ||
      a.height < 3 ||
      ((0 !== i.left || 0 !== i.top) && ((a.left += i.left), (a.top += i.top)),
    ...
    if (
      ...
      let n = I(e, t),
        r = n.value || n.placeholder || e.textContent || '',
        i = j(e, r, a),
        o = _(e, i, !1, t),
        h = e.tagName.toLowerCase();
      return (
        'select' === e.tagName.toLowerCase() &&
          (r = e.options[e.selectedIndex].textContent || ''),
        ('input' === e.tagName.toLowerCase() ||
          'textarea' === e.tagName.toLowerCase()) &&
          e.value &&
          (r = e.value),
      ...
      const n = I(e, t),
        r = ((e, t) => {
          ...
          return {
            ...
            after: 'none' === r ? '' : r.replace(/"/g, ''),
          };
        })(e, t),
        i = e.innerText || r.before || r.after || '',
        o = j(e, i, a),
        h = _(e, o, !1, t);
      return {
        id: o,
        ...
        locator: h,
        attributes: f(c({}, n), { htmlTagName: $(e), nodeType: 'BUTTON Node' }),
        content: i,
        rect: a,
        center: [
          Math.round(a.left + a.width / 2),
    ...
    if (
      ...
      return {
        ...
        attributes: f(
          ...
          { nodeType: 'IMG Node', htmlTagName: $(e) },
        ),
        nodeType: 'IMG Node',
        content: '',
        rect: a,
    ...
    if ('#text' === e.nodeName.toLowerCase() && !T(e)) {
      const n =
        null == (o = e.textContent) ? void 0 : o.trim().replace(/\n+/g, ' ');
      if (!n) return null;
      const r = I(e, t),
        i = Object.keys(r);
      if (!n.trim() && 0 === i.length) return null;
      const h = j(e, n, a),
        s = _(e, h, !0, t);
      return {
        id: h,
        ...
        nodeType: 'TEXT Node',
        locator: s,
        attributes: f(c({}, r), { nodeType: 'TEXT Node', htmlTagName: $(e) }),
        center: [
          Math.round(a.left + a.width / 2),
          Math.round(a.top + a.height / 2),
        ],
  ...
  function U(e, t = !1) {
    ...
    const n = document.body || document,
      r = e || n,
      i = [];
    function o(e, t, n, r = 1, i = { left: 0, top: 0 }) {
      ...
      if (
        ...
        return null;
      const h = { node: a, children: [] };
      if (
        (null == a ? void 0 : a.nodeType) === 'BUTTON Node' ||
        (null == a ? void 0 : a.nodeType) === 'IMG Node' ||
        (null == a ? void 0 : a.nodeType) === 'TEXT Node' ||
        (null == a ? void 0 : a.nodeType) === 'FORM_ITEM Node' ||
        (null == a ? void 0 : a.nodeType) === 'CONTAINER Node'
      )
        return h;
      const s = H(e, r, t);
      for (let r = 0; r < e.childNodes.length; r++) {
        O('will dfs', e.childNodes[r]);
        const a = o(e.childNodes[r], t, n, s.zoom, i);
        a && h.children.push(a);
      }
      return h;
    }
    const a = o(r, window, document, 1, { left: 0, top: 0 });
    if ((a && i.push(a), r === n)) {
      const e = document.querySelectorAll('iframe');
      for (let t = 0; t < e.length; t++) {
        const n = e[t];
        if (n.contentDocument && n.contentWindow) {
          const e = W(n, window, document, 1);
          if (e) {
            const t = o(
        ...
        if (
          ...
          ((e) => {
              ...
              o = ((e) => {
                ...
                if (e && 1 === e.nodeType)
                  for (let r = 0; r < e.attributes.length; r++) {
                    ...
                    n[i.nodeName] = null != (t = i.nodeValue) ? t : '';
                  }
                return n;
              })(e),
              a = ((e) => {
                var t, n, r, i;
                const o = Math.round(
                    Number.parseFloat(null != (t = e.x) ? t : '0'),
                  ),
                  a = Math.round(
                    Number.parseFloat(null != (n = e.y) ? n : '0'),
                  );
                return {
                  left: Math.max(0, Math.floor(o)),
                  top: Math.max(0, Math.floor(a)),
                  width: Math.max(
                    0,
                    Math.round(
                      Number.parseFloat(null != (r = e.width) ? r : '0'),
                    ),
                  ),
                  height: Math.max(
                    0,
                    Math.round(
                      Number.parseFloat(null != (i = e.height) ? i : '0'),
                    ),
                  ),
                };
              })(o),
              h = j(null, o.placeholder, a),
              s =
                (3 === e.nodeType &&
                  (null == (r = e.nodeValue) ? void 0 : r.trim())) ||
                '';
            switch (e.nodeName.toUpperCase()) {
              ...
              default:
                i =
                  'android:id/input' === o.id || 'android:id/inputArea' === o.id
                    ? 'FORM_ITEM Node'
                    : 'CONTAINER Node';
            }
            const l = ((e) => {
                ...
                const t = (e, t) => {
                    let n = 1;
                    for (let r = e.previousSibling; r; r = r.previousSibling)
                      1 === r.nodeType && r.nodeName === t && n++;
                    return n;
                  },
                  n = (e) => {
                    for (const t of [
                      ...
                      if (e.hasAttribute(t)) {
                        ...
                        if (n && '' !== n.trim()) return `[@${t}="${n}"]`;
                      }
                    return '';
                  },
                  r = (e, i = '') => {
                    if (
                      (e.parentNode && (i = r(e.parentNode, i)),
                      1 === e.nodeType)
                    ) {
            ...
            'CONTAINER Node' !== d.nodeType && t.push(d);
          })(r),
          r.childNodes && r.childNodes.length > 0)
        )
          for (let t = 0; t < r.childNodes.length; t++) e(r.childNodes[t], o);
      })(e, { node: e, children: [] }),
      t
    );
  }
  return p(t({}, '__esModule', { value: !0 }), y);
})();
